[app](../../index.md) / [com.example.nestapp.activities](../index.md) / [MainActivity](index.md) / [onCreate](./on-create.md)
...
Called when app is first opened (created).

### Parameters

`savedInstanceState` - Previous state.